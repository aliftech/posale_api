...
use App\Models\SuplyerModel;
use Firebase\JWT\JWT;
use \CodeIgniter\I18n\Time;

class Suplyer extends ResourceController
{
    /**
    ...
    public function create()
    {
        ...
        if(!$this->validate($rules)) {
            ...
            $data = [
                ...
                'suplyer_name' => $this->request->getVar('suplyer_name'),
